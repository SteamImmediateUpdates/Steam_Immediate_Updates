...
### WARNING: THIS SCRIPT IS DESIGNED PRIMARILY TO BE RUN AUTOMATICALLY ON A SCHEDULE. AS SUCH, WHEN RUNNIONG IT,
### THERE WILL BE NO USER INPUT OR CONFIRMATIONS. IT WILL DO WHAT IT IS DESIGNED TO DO VERY QUICKLY AND WITH NO
### PROMPTING. READ ALL OF THE FOLLOWING BEFORE YOU RUN IT TO ENSURE THAT YOU UNDERSTAND EXACTLY WHAT IT DOES.
